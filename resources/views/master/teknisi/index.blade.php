...
@section('page-subtitle', 'Kelola data teknisi pemasangan')
...
@section('content')
    ...
    <div x-data="{ 
        ...
        openEdit(item) {
            this.mode = 'edit';
            this.formAction = '/master/teknisi/' + item.id;
            this.formMethod = 'PUT';
            this.formData = { 
        ...
        <x-list-filter-bar
            :reset-url="route('master.teknisi.index')"
        ...
        <div class="card overflow-hidden">
            <div class="px-6 py-5 border-b border-border flex items-center justify-between">
                <h2 class="text-content-primary font-semibold text-lg">Daftar Teknisi</h2>
                    ...
                    <tbody class="divide-y divide-border">
                        @forelse($teknisi as $item)
                            <tr class="hover:bg-base-page transition-colors">
                                <td class="px-6 py-4 text-sm text-content-primary">{{ $item->nama_teknisi }}</td>
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <form method="POST" action="{{ route('master.teknisi.destroy', $item) }}"
                        ...
                        @empty
                            <tr>
                                <td colspan="3" class="px-6 py-10 text-center text-content-tertiary">Belum ada data teknisi.
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
            ...
            <div x-show="showModal" x-transition:enter="transition ease-out duration-300"
                ...
                <div class="px-6 py-4 border-b border-border flex justify-between items-center bg-base-page">
                    <h3 class="text-lg font-semibold text-content-primary"
                        x-text="mode === 'create' ? 'Tambah Teknisi Baru' : 'Edit Data Teknisi'"></h3>
                ...
                <form :action="formAction" method="POST">
                    ...
                    <div class="px-6 py-4 border-t border-border flex justify-end gap-3 bg-base-page">
                        ...
                        <button type="submit" class="btn-primary"
                            x-text="mode === 'create' ? 'Simpan Teknisi' : 'Update Teknisi'"></button>
                    </div>
                </form>
            </div>
        </div>
